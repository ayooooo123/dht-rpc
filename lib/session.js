...
module.exports = class Session {
  ...
  query({ target, command, value }, opts = {}) {
    ...
    return this.dht.query({ target, command, value }, sessionOptions(this.dht, opts, this))
  }
  ...
  request({ token, command, target, value }, to, opts = {}) {
    ...
    return this.dht.request(
      ...
      to,
      sessionOptions(this.dht, opts, this)
    )
  }
...
function sessionOptions(dht, opts, session) {
  const copy = {}
  ...
  if (dht.outboundPolicy === 'transport-only') {
